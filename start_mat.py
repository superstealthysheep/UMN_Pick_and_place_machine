...
def add_mat_positions(infilename, outfilename, delimiter=",", \
                      grid_spacing = 10, grid_column_width = 10, grid_origin=(0,0)):
  
  with open(infilename, mode="r") as infile, open(outfilename, mode="w") as outfile:
    ...
    for row in csv_reader:
      ...
      grid_column = (grid_column + 1) % grid_column_width
